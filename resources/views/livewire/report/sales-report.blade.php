<div class="p-6 space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Rapport de Ventes</h1>
            <p class="text-sm text-gray-500 mt-1">Consultez et exportez l'historique des facturations.</p>
        </div>
    ...
    <style>
        @media print {
            .fi-header-actions, .fi-ta-header-actions, .fi-ta-filters, .fi-ta-header, .fi-ta-actions, .bg-white.p-6.rounded-xl.shadow-sm.border, .flex.flex-col.md\:flex-row {
